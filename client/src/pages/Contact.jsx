    ...
    <div className="bg-gradient-to-r from-[#fffbee]  to-white py-16 pt-28">
      <form className="flex flex-col items-center text-sm text-slate-800">
            ...
            <p className="max-md:text-sm text-gray-500 pb-10 text-center">
                Or just reach out manually to us at <a href="#" className="text-secondary hover:underline">contact@nestorria.com</a>
            </p>
            ...
            <div className="max-w-96 w-full px-4">
                ...
                <div className="flex items-center mt-2 mb-4 h-10 pl-3 border border-slate-300 bg-secondary/10 rounded-full focus-within:ring-2 focus-within:ring-black/80 transition-all overflow-hidden">
                    <img src={assets.user}  className='invert-50' width={19} />
                ...
                <div className="flex items-center mt-2 mb-4 h-10 pl-3 border border-slate-300 bg-secondary/10 rounded-full focus-within:ring-2 focus-within:ring-indigo-400 transition-all overflow-hidden">
                    <img src={assets.mail} alt="" className='invert-50' width={19} />
                ...
                <textarea rows="4" className="w-full mt-2 p-2 border border-slate-300 bg-secondary/10 rounded-lg resize-none outline-none focus:ring-2 focus-within:ring-indigo-400 transition-all" placeholder="Enter your message" required></textarea>
